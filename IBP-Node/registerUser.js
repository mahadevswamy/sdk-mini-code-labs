...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
    ...
    fabric_ca_client = new Fabric_CA_Client('https://admin:09362f82a5@n5d87d4d4d68b432d809e2225c47c26aa-org1-ca.uk01.blockchain.ibm.com:31011', null ,'org1CA', crypto_suite);
    ...
    return fabric_ca_client.register({enrollmentID: 'user3', affiliation: 'org1',role: 'client'}, admin_user);
}).then((secret) => {

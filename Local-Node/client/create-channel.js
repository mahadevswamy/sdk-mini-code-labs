...
//
	...
	return Client.newDefaultKeyValueStore({
		...
		let envelope_bytes = fs.readFileSync(path.join(__dirname, '../artifacts/channel/mychannel.tx'));
		config = client.extractChannelConfig(envelope_bytes);
		logger.info('Successfully extracted the config update from the configtx envelope');
	...
	.then((result) => {
		...
		logger.error('Failed to create the channel: ' + err.stack ? err.stack : err);
